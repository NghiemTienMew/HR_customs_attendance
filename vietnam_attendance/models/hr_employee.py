...
class HrEmployee(models.Model):
    ...
    # Thêm trường total_overtime mà không phụ thuộc vào overtime_status
    ...
    # Phương thức tính total_overtime sửa đổi không phụ thuộc vào overtime_status
    @api.depends()
