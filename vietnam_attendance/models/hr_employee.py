...
class HrEmployee(models.Model):
    ...
    # 1) Thêm quan hệ One2many tới overtime
    overtime_ids = fields.One2many(
        'vietnam.attendance.overtime', 'employee_id',
        string='Bản ghi tăng ca'
    )
    
    # Thêm trường total_overtime - không phụ thuộc trực tiếp vào bất kỳ trường nào
    ...
    # Phương thức tính tổng thời gian tăng ca không phụ thuộc vào bất kỳ trường nào
    # Sẽ được cập nhật thông qua trigger từ model vietnam.attendance.overtime
    @api.depends()
    def _compute_total_overtime(self):
        for employee in self:
            ...
            # Tính tổng thời gian tăng ca từ trường duration (không phải hours)
            employee.total_overtime = sum(overtimes.mapped('duration'))
