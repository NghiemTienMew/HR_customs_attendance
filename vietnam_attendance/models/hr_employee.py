...
class HrEmployee(models.Model):
    ...
    # Hoàn toàn xóa bỏ trường total_overtime cũ
    # Tạo trường mới với tên khác để tránh xung đột với cache
    employee_total_overtime = fields.Float(string='Tổng thời gian tăng ca', compute='_compute_employee_total_overtime')
    ...
    # Tạo một phương thức tính toán mới với tên khác
    # và không có @api.depends() để tránh phụ thuộc vào các trường không tồn tại
    def _compute_employee_total_overtime(self):
        for employee in self:
            ...
            # Sử dụng trường 'duration' thay vì 'hours'
            employee.employee_total_overtime = sum(overtimes.mapped('duration'))
