...
class HrEmployee(models.Model):
    ...
    # Sửa lỗi: Thay đổi compute để không phụ thuộc vào overtime_status
    ...
    # Lỗi ở đây: phụ thuộc vào trường overtime_status không tồn tại
    # Thay đổi @api.depends() thành rỗng hoặc phụ thuộc vào các trường khác
    @api.depends()
    def _compute_total_overtime(self):
        for employee in self:
            ...
            # Sửa lỗi: Trường 'hours' không tồn tại, sử dụng 'duration' thay thế
